...
from .func import *
def SpaVGN(adata, test_3D_data, integral_coords, position_info, train_lr, train_hr, in_tissue_matrix, patch_size, batch_size=512, num_heads=8, epoch=500, lr=0.0005):
    ...
    torch.save(net.state_dict(), 'brainsp4.14.params')
