from NEDI import NEDI_run as NEDI
from MUSTBE.network import VisionTransformer as model
from MUSTBE import *
...
def get_data_NEDI(process_data, truth_counts):
    ...
    for i in range(simu_3D.shape[0]):
        ...
        ##############
        #interpolated_data = interpolated_data[0:-1, 0:-1]
        interpolated_set[i] = interpolated_data
...
def get_data_SpaVGN(process_data, load, patch_size, truth_counts, num_heads):
