...
def get_mel1_rep1():
    counts = pd.read_csv('/root/mustbe/data/mel1_rep1/counts.csv', index_col=0)  # index_col=0:第一列为索引值
    coords = pd.read_csv('/root/mustbe/data/mel1_rep1/coords.csv', index_col=0)
